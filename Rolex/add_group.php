...
<div class="login-page">
  <div class="text-center">
    <h3><?php echo $lang['Add new user Group']; ?></h3><br>
  </div>
  <?php echo display_msg($msg); ?>
  <form method="post" action="add_group.php" class="clearfix">
    <div class="form-group">
      <label for="name" class="control-label"><?php echo $lang['Group Name']; ?></label>
      <input type="name" class="form-control" name="group-name">
    </div>
    <div class="form-group">
      <label for="level" class="control-label"><?php echo $lang['Group Level']; ?></label>
    ...
    <div class="form-group clearfix">
      <button type="submit" name="add" class="btn btn-info"><?php echo $lang['Update']; ?></button>
    </div>
  </form>
</div>
