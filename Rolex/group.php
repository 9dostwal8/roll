  ...
  <div class="col-md-12">
    ...
    <div class="panel-heading clearfix">
      <strong>
       ...
       <a href="add_group.php" class="btn btn-info pull-right btn-sm"><?php echo $lang['Add New Group']; ?></a>
    </div>
      ...
      <table class="table table-bordered">
        <thead>
          <tr>
            ...
            <th class="text-center" style="width: 20%;"><?php echo $lang['Group Level']; ?></th>
            <th class="text-center" style="width: 15%;"><?php echo $lang['Status']; ?></th>
