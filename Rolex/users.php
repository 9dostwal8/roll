    ...
    <div class="panel panel-default">
      <div class="panel-heading clearfix">
        <strong>
         ...
         <a href="add_user.php" class="btn btn-info pull-right"><?php echo $lang['Add New User']; ?></a>
      </div>
      ...
      <table class="table table-bordered table-striped">
        <thead>
          <tr>
            ...
            <th class="text-center" style="width: 15%;"><?php echo $lang['User Role']; ?></th>
            <th class="text-center" style="width: 10%;"><?php echo $lang['Status']; ?></th>
            <th style="width: 20%;"><?php echo $lang['Last Login']; ?></th>
