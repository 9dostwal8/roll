   ...
   <div class="row">
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          <strong>
            ...
            <span><?php echo $lang['Add New Category']; ?></span>
         </strong>
        </div>
        <div class="panel-body">
          <form method="post" action="categorie.php">
            <div class="form-group">
                <input type="text" class="form-control" name="categorie-name" placeholder="<?php echo $lang['Category Name']; ?>">
            </div>
            <button type="submit" name="add_cat" class="btn btn-primary"><?php echo $lang['Add Category']; ?></button>
        </form>
        </div>
      </div>
    </div>
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <strong>
          <span class="glyphicon glyphicon-th"></span>
          <span><?php echo $lang['All Categories']; ?></span>
       </strong>
      </div>
        <div class="panel-body">
